...
class DamageTypeTagProvider(
  ...
  override fun configure(arg: RegistryWrapper.WrapperLookup) {
    getOrCreateTagBuilder(DamageTypeTags.IS_PROJECTILE).add(Registration.ModDamageSources.LASER)
    getOrCreateTagBuilder(DamageTypeTags.IS_FIRE).add(Registration.ModDamageSources.LASER)
  }
}
