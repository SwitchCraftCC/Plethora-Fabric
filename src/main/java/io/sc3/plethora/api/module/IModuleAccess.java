...
public interface IModuleAccess {
    ...
    /**
     * Get data specific to this module. This can be written to and persisted and shared with the client. It is not
     * bound to the item stack however and is discarded when the module is removed.
     *
