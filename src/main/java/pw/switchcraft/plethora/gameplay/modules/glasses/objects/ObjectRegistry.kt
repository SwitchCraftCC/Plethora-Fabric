...
object ObjectRegistry {
  ...
  private val FACTORIES = arrayOf(
    // 2D
    Factory { id, parent -> Rectangle(id, parent) },
    Factory { id, parent -> Line(id, parent) },
    Factory { id, parent -> Dot(id, parent) },
    Factory { id, parent -> Text(id, parent) },
    Factory { id, parent -> Triangle(id, parent) },
    Factory { id, parent -> Polygon(id, parent) },
    Factory { id, parent -> LineLoop(id, parent) },
    ...
    null, // ObjectFrame
  Factory { id, parent -> Box(id, parent) },
