...
val satinVersion: String by project
...
repositories {
  ...
  maven("https://ladysnake.jfrog.io/artifactory/mods") // Satin, Trinkets
}
...
dependencies {
  ...
  modImplementation("io.github.ladysnake:satin:${satinVersion}")
